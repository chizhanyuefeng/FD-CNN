...
ADL_DATA_SAVE_FILE = "C:\data\\fall_down_detection.git\data\ADL\STD\STD_data.csv"
INDEX_FILE = 'C:\data\\fall_down_detection.git\data\ADL\STD\indexfile.csv'
path = 'C:\data\MobiAct_Dataset_v2.0\Annotated Data\STD'
